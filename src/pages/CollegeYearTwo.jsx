  ...
  return (
    <main className="inside-page album-page year-two-page page-enter">
      ...
      <div className="year-two-layout">
        ...
        <aside className="changes-note"><WashiTape /><span className="scrap-label">things that changed</span>{collegeYearTwo.changes.map((change) => <p key={change}>{change}</p>)}</aside>
      </div>
